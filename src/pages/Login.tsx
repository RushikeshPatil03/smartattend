      ...
      <div className="relative z-10 mx-auto w-full max-w-lg px-4 py-8 sm:px-6 flex-1 flex flex-col justify-center items-center">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <div className="flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 via-indigo-500 to-cyan-400 p-[1.5px] shadow-[0_12px_30px_-8px_rgba(59,130,246,0.8)]">
